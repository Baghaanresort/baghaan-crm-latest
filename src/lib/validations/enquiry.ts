...
export const EnquirySchema = z.object({
  ...
  status: z.enum(['new', 'in_progress', 'rooms_blocked', 'advance_pending', 'advance_confirmed', 'booked', 'lost']),
...
export const UpdateEnquirySchema = z.object({
  ...
  status: z.enum(['new', 'in_progress', 'rooms_blocked', 'advance_pending', 'advance_confirmed', 'booked', 'lost']).optional(),
